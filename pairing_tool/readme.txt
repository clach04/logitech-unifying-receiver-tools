...
NOTE this will remove the previous pairing the device had previously.
This code does not remove a pairing or list pairsings for the receiver.

To determine the parameter to pairing_tool, check:
